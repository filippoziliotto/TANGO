...
from habitat_baselines.rl.ppo.utils.map.Reprojection import getMapSizeInCells, project2dPClIntoWorldMap, ReprojectLocal2Global
...
class DirectDepthMapper(nn.Module):
    ...
    def __init__(self, 
                 ...
                 cy = 128,
                 camera_height = 0.88,
                 near_th = 0.1, far_th = 10.0, h_min = 0.0, h_max = 1.0,
    ...
    def forward(self, depth, device, pose = torch.eye(4).float()):
        self.device = device
