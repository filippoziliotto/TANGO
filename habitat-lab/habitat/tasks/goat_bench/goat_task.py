...
@registry.register_sensor(name="GoatPointGoalWithGPSCompassSensor")
class GoatPointGoalWithGPSCompassSensor(PointGoalSensor):
    cls_uuid: str = "goat_pointgoal_with_gps_compass"
